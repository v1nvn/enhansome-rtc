...
* [Sippy B2BUA](https://github.com/sippy/b2bua) ⭐ 195 | 🐛 28 | 🌐 Python | 📅 2026-02-19 - Back-to-back user agent server written in Python.
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 175 | 🐛 20 | 🌐 C++ | 📅 2026-02-20 - SIP server suite comprising proxy, presence and group chat functions.
...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 911 | 🐛 113 | 🌐 C | 📅 2026-02-20 - RTP and UDP based media traffic proxy, usable as a kernel module.
* [SEMS](https://github.com/sems-server/sems) ⭐ 181 | 🐛 15 | 🌐 C++ | 📅 2026-02-19 - Open source media and application server for SIP based VoIP services.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,637 | 🐛 374 | 🌐 C | 📅 2026-02-20 - Fully featured TURN/STUN server supporting multiple platforms.
* [STUNTMAN](https://github.com/jselbie/stunserver) ⭐ 1,582 | 🐛 12 | 🌐 C++ | 📅 2026-02-13 - RFC compliant open source STUN implementation.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 1,903 | 🐛 44 | 🌐 Shell | 📅 2026-02-10 - Multi-protocol capturing and monitoring framework for RTC.
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,160 | 🐛 74 | 🌐 C | 📅 2026-01-26 - Terminal based SIP flow viewer.
...
* [SIPVicious](https://github.com/EnableSecurity/sipvicious) ⭐ 1,036 | 🐛 0 | 🌐 Python | 📅 2026-01-06 - Suite of security tools that can be used to audit SIP based VoIP systems.
* [sipexer](https://github.com/miconda/sipexer) ⭐ 378 | 🐛 2 | 🌐 Go | 📅 2026-01-05 - Modern and flexible SIP command line tool.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,560 | 🐛 16 | 🌐 TypeScript | 📅 2026-02-16 - Telecommunication stack built with Node.js.
* [IVOZ Provider](https://github.com/irontec/ivozprovider) ⭐ 221 | 🐛 85 | 🌐 PHP | 📅 2026-02-18 - Multitenant solution for VoIP telephony providers.
* [Sayna](https://github.com/SaynaAI/sayna) ⭐ 127 | 🐛 0 | 🌐 Rust | 📅 2026-02-08 - Real-time speech infrastructure for voice AI with WebSocket streaming, SIP telephony and pluggable STT/TTS providers.
...
* [PyFreeBilling](https://github.com/mwolff44/pyfreebilling) ⭐ 109 | 🐛 6 | 🌐 HTML | 📅 2026-02-10 - Wholesale billing platform for Kamailio and FreeSWITCH.
...
* [simple-peer](https://github.com/feross/simple-peer) ⭐ 7,784 | 🐛 127 | 🌐 JavaScript | 📅 2024-06-26 - WebRTC video, voice, and data channels abstraction for Node.js and the browser.
* [adapter.js](https://github.com/webrtcHacks/adapter) ⭐ 3,740 | 🐛 7 | 🌐 JavaScript | 📅 2025-08-08 - JavaScript shim for abstracting WebRTC spec changes and inconsistencies.
...
* [Socio](https://github.com/Rolands-Laucis/Socio) ⭐ 126 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-17 - A WebSocket Real-Time Communication (RTC) API framework. Realtime Front-end, Back-end reactivity.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,480 | 🐛 135 | 🌐 C++ | 📅 2026-02-07 - Standalone WebRTC DataChannels C++ implementation.
* [libSRTP](https://github.com/cisco/libsrtp) ⭐ 1,360 | 🐛 34 | 🌐 C | 📅 2026-02-19 - Secure Real-time Transport Protocol (SRTP) library for C.
* [usrsctp](https://github.com/sctplab/usrsctp) ⭐ 743 | 🐛 167 | 🌐 C | 📅 2025-10-16 - Portable Stream Control Transmission Protocol (SCTP) user-land stack.
* [libre](https://github.com/creytiv/re) ⭐ 543 | 🐛 18 | 🌐 C | 📅 2024-02-06 - Portable SIP Stack along with companion libraries for media handling, STUN/TURN and a modular user agent.
* [rawrtc](https://github.com/rawrtc/rawrtc) ⭐ 390 | 🐛 59 | 🌐 C | 📅 2021-12-23 - WebRTC and ORTC library with a small footprint.
* [Sofia-SIP](https://github.com/freeswitch/sofia-sip) ⭐ 322 | 🐛 110 | 🌐 C | 📅 2026-02-20 - Open source SIP library used by FreeSWITCH.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,013 | 🐛 34 | 🌐 Python | 📅 2025-11-29 - WebRTC and ORTC implementation for Python using asyncio.
...
* [rtcrs/webrtc](https://github.com/rtcrs/webrtc) ⭐ 4,945 | 🐛 3 | 🌐 Rust | 📅 2026-02-21 - WebRTC stack, supporting SDP, RTP, RTCP and SRTP.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,612 | 🐛 0 | 📅 2025-06-08 - Research resources in the 3G/4G/5G Cellular security space.
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 900 | 🐛 1 | 🌐 Python | 📅 2026-02-08 - Telco resources and projects.
* [Awesome 5G](https://github.com/calee0219/awesome-5g) ⭐ 870 | 🐛 4 | 🌐 Shell | 📅 2026-02-03 - 5G frameworks, libraries, software and resources.
* [Awesome RTC Hacking](https://github.com/EnableSecurity/awesome-rtc-hacking) ⭐ 514 | 🐛 0 | 📅 2025-07-25 - Real Time Communications hacking and penetration testing resources.
