...
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 181 | 🐛 23 | 🌐 C++ | 📅 2026-04-23 - SIP server suite comprising proxy, presence and group chat functions.
...
* [SEMS](https://github.com/sems-server/sems) ⭐ 183 | 🐛 6 | 🌐 C++ | 📅 2026-04-24 - Open source media and application server for SIP based VoIP services.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,899 | 🐛 368 | 🌐 C | 📅 2026-04-23 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,776 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-08 - Telecommunication stack built with Node.js.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,567 | 🐛 138 | 🌐 C++ | 📅 2026-04-22 - Standalone WebRTC DataChannels C++ implementation.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,707 | 🐛 1 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
