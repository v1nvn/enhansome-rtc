...
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 181 | 🐛 22 | 🌐 C++ | 📅 2026-04-08 - SIP server suite comprising proxy, presence and group chat functions.
...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 930 | 🐛 109 | 🌐 C | 📅 2026-04-09 - RTP and UDP based media traffic proxy, usable as a kernel module.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,845 | 🐛 374 | 🌐 C | 📅 2026-04-09 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [SIPVicious](https://github.com/EnableSecurity/sipvicious) ⭐ 1,068 | 🐛 0 | 🌐 Python | 📅 2026-03-06 - Suite of security tools that can be used to audit SIP based VoIP systems.
* [sipexer](https://github.com/miconda/sipexer) ⭐ 383 | 🐛 2 | 🌐 Go | 📅 2026-04-09 - Modern and flexible SIP command line tool.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,760 | 🐛 26 | 🌐 TypeScript | 📅 2026-04-08 - Telecommunication stack built with Node.js.
* [IVOZ Provider](https://github.com/irontec/ivozprovider) ⭐ 221 | 🐛 90 | 🌐 PHP | 📅 2026-04-09 - Multitenant solution for VoIP telephony providers.
...
* [adapter.js](https://github.com/webrtcHacks/adapter) ⭐ 3,736 | 🐛 10 | 🌐 JavaScript | 📅 2026-04-09 - JavaScript shim for abstracting WebRTC spec changes and inconsistencies.
...
* [libSRTP](https://github.com/cisco/libsrtp) ⭐ 1,372 | 🐛 32 | 🌐 C | 📅 2026-03-14 - Secure Real-time Transport Protocol (SRTP) library for C.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,036 | 🐛 31 | 🌐 Python | 📅 2025-11-29 - WebRTC and ORTC implementation for Python using asyncio.
...
* [rtcrs/webrtc](https://github.com/rtcrs/webrtc) ⭐ 4,999 | 🐛 18 | 🌐 Rust | 📅 2026-03-08 - WebRTC stack, supporting SDP, RTP, RTCP and SRTP.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,680 | 🐛 1 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 920 | 🐛 1 | 🌐 Python | 📅 2026-03-31 - Telco resources and projects.
...
* [SIP Resources](https://github.com/miconda/sip-resources) ⭐ 254 | 🐛 2 | 📅 2025-09-09 - Useful SIP resources curated by Kamailio's head developer.
