...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 931 | 🐛 108 | 🌐 C | 📅 2026-04-10 - RTP and UDP based media traffic proxy, usable as a kernel module.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,848 | 🐛 373 | 🌐 C | 📅 2026-04-10 - Fully featured TURN/STUN server supporting multiple platforms.
* [STUNTMAN](https://github.com/jselbie/stunserver) ⭐ 1,593 | 🐛 13 | 🌐 C++ | 📅 2026-02-13 - RFC compliant open source STUN implementation.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 1,920 | 🐛 43 | 🌐 Shell | 📅 2026-04-09 - Multi-protocol capturing and monitoring framework for RTC.
...
* [SIPVicious](https://github.com/EnableSecurity/sipvicious) ⭐ 1,068 | 🐛 0 | 🌐 Python | 📅 2026-04-10 - Suite of security tools that can be used to audit SIP based VoIP systems.
* [sipexer](https://github.com/miconda/sipexer) ⭐ 383 | 🐛 2 | 🌐 Go | 📅 2026-04-10 - Modern and flexible SIP command line tool.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,763 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-08 - Telecommunication stack built with Node.js.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,554 | 🐛 137 | 🌐 C++ | 📅 2026-04-05 - Standalone WebRTC DataChannels C++ implementation.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,038 | 🐛 33 | 🌐 Python | 📅 2025-11-29 - WebRTC and ORTC implementation for Python using asyncio.
...
* [rtcrs/webrtc](https://github.com/rtcrs/webrtc) ⭐ 5,003 | 🐛 19 | 🌐 Rust | 📅 2026-03-08 - WebRTC stack, supporting SDP, RTP, RTCP and SRTP.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,687 | 🐛 1 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
...
* [Awesome RTC Hacking](https://github.com/EnableSecurity/awesome-rtc-hacking) ⭐ 531 | 🐛 0 | 📅 2025-07-25 - Real Time Communications hacking and penetration testing resources.
* [SIP Resources](https://github.com/miconda/sip-resources) ⭐ 254 | 🐛 1 | 📅 2026-04-10 - Useful SIP resources curated by Kamailio's head developer.
