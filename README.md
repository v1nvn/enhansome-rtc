...
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 175 | 🐛 20 | 🌐 C++ | 📅 2026-02-19 - SIP server suite comprising proxy, presence and group chat functions.
...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 911 | 🐛 113 | 🌐 C | 📅 2026-02-19 - RTP and UDP based media traffic proxy, usable as a kernel module.
* [SEMS](https://github.com/sems-server/sems) ⭐ 181 | 🐛 14 | 🌐 C++ | 📅 2026-02-19 - Open source media and application server for SIP based VoIP services.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,633 | 🐛 374 | 🌐 C | 📅 2026-02-20 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 1,902 | 🐛 44 | 🌐 Shell | 📅 2026-02-10 - Multi-protocol capturing and monitoring framework for RTC.
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,159 | 🐛 74 | 🌐 C | 📅 2026-01-26 - Terminal based SIP flow viewer.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,561 | 🐛 16 | 🌐 TypeScript | 📅 2026-02-16 - Telecommunication stack built with Node.js.
...
* [Sayna](https://github.com/SaynaAI/sayna) ⭐ 126 | 🐛 0 | 🌐 Rust | 📅 2026-02-08 - Real-time speech infrastructure for voice AI with WebSocket streaming, SIP telephony and pluggable STT/TTS providers.
...
* [simple-peer](https://github.com/feross/simple-peer) ⭐ 7,783 | 🐛 127 | 🌐 JavaScript | 📅 2024-06-26 - WebRTC video, voice, and data channels abstraction for Node.js and the browser.
...
* [Sofia-SIP](https://github.com/freeswitch/sofia-sip) ⭐ 322 | 🐛 109 | 🌐 C | 📅 2025-11-14 - Open source SIP library used by FreeSWITCH.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,011 | 🐛 34 | 🌐 Python | 📅 2025-11-29 - WebRTC and ORTC implementation for Python using asyncio.
...
* [rtcrs/webrtc](https://github.com/rtcrs/webrtc) ⭐ 4,944 | 🐛 3 | 🌐 Rust | 📅 2026-02-20 - WebRTC stack, supporting SDP, RTP, RTCP and SRTP.
...
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 899 | 🐛 1 | 🌐 Python | 📅 2026-02-08 - Telco resources and projects.
