...
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 180 | 🐛 23 | 🌐 C++ | 📅 2026-03-25 - SIP server suite comprising proxy, presence and group chat functions.
...
* [simple-peer](https://github.com/feross/simple-peer) ⭐ 7,790 | 🐛 126 | 🌐 JavaScript | 📅 2024-06-26 - WebRTC video, voice, and data channels abstraction for Node.js and the browser.
