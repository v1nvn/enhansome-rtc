...
* [SEMS](https://github.com/sems-server/sems) ⭐ 183 | 🐛 8 | 🌐 C++ | 📅 2026-04-18 - Open source media and application server for SIP based VoIP services.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,880 | 🐛 369 | 🌐 C | 📅 2026-04-16 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [sipexer](https://github.com/miconda/sipexer) ⭐ 384 | 🐛 2 | 🌐 Go | 📅 2026-04-17 - Modern and flexible SIP command line tool.
...
* [adapter.js](https://github.com/webrtcHacks/adapter) ⭐ 3,736 | 🐛 10 | 🌐 JavaScript | 📅 2026-04-17 - JavaScript shim for abstracting WebRTC spec changes and inconsistencies.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,561 | 🐛 135 | 🌐 C++ | 📅 2026-04-17 - Standalone WebRTC DataChannels C++ implementation.
...
* [Sofia-SIP](https://github.com/freeswitch/sofia-sip) ⭐ 326 | 🐛 110 | 🌐 C | 📅 2026-04-09 - Open source SIP library used by FreeSWITCH.
...
* [rtcrs/webrtc](https://github.com/rtcrs/webrtc) ⭐ 5,008 | 🐛 20 | 🌐 Rust | 📅 2026-03-08 - WebRTC stack, supporting SDP, RTP, RTCP and SRTP.
...
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 923 | 🐛 1 | 🌐 Python | 📅 2026-04-14 - Telco resources and projects.
* [Awesome 5G](https://github.com/calee0219/awesome-5g) ⭐ 878 | 🐛 4 | 🌐 Shell | 📅 2026-02-03 - 5G frameworks, libraries, software and resources.
