...
* [Sippy B2BUA](https://github.com/sippy/b2bua) ⭐ 196 | 🐛 28 | 🌐 Python | 📅 2026-03-16 - Back-to-back user agent server written in Python.
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 180 | 🐛 22 | 🌐 C++ | 📅 2026-04-01 - SIP server suite comprising proxy, presence and group chat functions.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,817 | 🐛 376 | 🌐 C | 📅 2026-03-26 - Fully featured TURN/STUN server supporting multiple platforms.
* [STUNTMAN](https://github.com/jselbie/stunserver) ⭐ 1,592 | 🐛 13 | 🌐 C++ | 📅 2026-02-13 - RFC compliant open source STUN implementation.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 1,918 | 🐛 43 | 🌐 Shell | 📅 2026-04-02 - Multi-protocol capturing and monitoring framework for RTC.
...
* [SIPVicious](https://github.com/EnableSecurity/sipvicious) ⭐ 1,062 | 🐛 0 | 🌐 Python | 📅 2026-03-06 - Suite of security tools that can be used to audit SIP based VoIP systems.
* [sipexer](https://github.com/miconda/sipexer) ⭐ 382 | 🐛 2 | 🌐 Go | 📅 2026-04-02 - Modern and flexible SIP command line tool.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,750 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-30 - Telecommunication stack built with Node.js.
...
* [Sayna](https://github.com/SaynaAI/sayna) ⭐ 166 | 🐛 0 | 🌐 Rust | 📅 2026-03-30 - Real-time speech infrastructure for voice AI with WebSocket streaming, SIP telephony and pluggable STT/TTS providers.
...
* [simple-peer](https://github.com/feross/simple-peer) ⭐ 7,793 | 🐛 128 | 🌐 JavaScript | 📅 2024-06-26 - WebRTC video, voice, and data channels abstraction for Node.js and the browser.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,542 | 🐛 141 | 🌐 C++ | 📅 2026-03-29 - Standalone WebRTC DataChannels C++ implementation.
* [libSRTP](https://github.com/cisco/libsrtp) ⭐ 1,368 | 🐛 32 | 🌐 C | 📅 2026-03-14 - Secure Real-time Transport Protocol (SRTP) library for C.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,032 | 🐛 31 | 🌐 Python | 📅 2025-11-29 - WebRTC and ORTC implementation for Python using asyncio.
...
* [rtcrs/webrtc](https://github.com/rtcrs/webrtc) ⭐ 4,991 | 🐛 18 | 🌐 Rust | 📅 2026-03-08 - WebRTC stack, supporting SDP, RTP, RTCP and SRTP.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,670 | 🐛 0 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 917 | 🐛 1 | 🌐 Python | 📅 2026-03-31 - Telco resources and projects.
* [Awesome 5G](https://github.com/calee0219/awesome-5g) ⭐ 874 | 🐛 4 | 🌐 Shell | 📅 2026-02-03 - 5G frameworks, libraries, software and resources.
* [Awesome RTC Hacking](https://github.com/EnableSecurity/awesome-rtc-hacking) ⭐ 528 | 🐛 0 | 📅 2025-07-25 - Real Time Communications hacking and penetration testing resources.
