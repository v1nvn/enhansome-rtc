...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 936 | 🐛 106 | 🌐 C | 📅 2026-04-22 - RTP and UDP based media traffic proxy, usable as a kernel module.
* [SEMS](https://github.com/sems-server/sems) ⭐ 183 | 🐛 17 | 🌐 C++ | 📅 2026-04-23 - Open source media and application server for SIP based VoIP services.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,894 | 🐛 367 | 🌐 C | 📅 2026-04-23 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 1,923 | 🐛 43 | 🌐 Shell | 📅 2026-04-20 - Multi-protocol capturing and monitoring framework for RTC.
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,174 | 🐛 79 | 🌐 C | 📅 2026-01-26 - Terminal based SIP flow viewer.
...
* [SIPVicious](https://github.com/EnableSecurity/sipvicious) ⭐ 1,068 | 🐛 0 | 🌐 Python | 📅 2026-04-18 - Suite of security tools that can be used to audit SIP based VoIP systems.
* [sipexer](https://github.com/miconda/sipexer) ⭐ 385 | 🐛 2 | 🌐 Go | 📅 2026-04-20 - Modern and flexible SIP command line tool.
* [sipsak](https://github.com/nils-ohlmeier/sipsak) ⭐ 170 | 🐛 25 | 🌐 C | 📅 2025-05-26 - SIP stress and diagnostics utility.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,775 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-08 - Telecommunication stack built with Node.js.
* [IVOZ Provider](https://github.com/irontec/ivozprovider) ⭐ 223 | 🐛 87 | 🌐 PHP | 📅 2026-04-21 - Multitenant solution for VoIP telephony providers.
...
* [simple-peer](https://github.com/feross/simple-peer) ⭐ 7,791 | 🐛 128 | 🌐 JavaScript | 📅 2024-06-26 - WebRTC video, voice, and data channels abstraction for Node.js and the browser.
* [adapter.js](https://github.com/webrtcHacks/adapter) ⭐ 3,737 | 🐛 9 | 🌐 JavaScript | 📅 2026-04-21 - JavaScript shim for abstracting WebRTC spec changes and inconsistencies.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,566 | 🐛 138 | 🌐 C++ | 📅 2026-04-22 - Standalone WebRTC DataChannels C++ implementation.
...
* [go-diameter](https://github.com/fiorix/go-diameter) ⭐ 284 | 🐛 17 | 🌐 Go | 📅 2026-04-22 - RFC compliant Diameter protocol library.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,045 | 🐛 36 | 🌐 Python | 📅 2025-11-29 - WebRTC and ORTC implementation for Python using asyncio.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,705 | 🐛 1 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 926 | 🐛 1 | 🌐 Python | 📅 2026-04-20 - Telco resources and projects.
...
* [SIP Resources](https://github.com/miconda/sip-resources) ⭐ 255 | 🐛 0 | 📅 2026-04-11 - Useful SIP resources curated by Kamailio's head developer.
