...
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 180 | 🐛 21 | 🌐 C++ | 📅 2026-04-03 - SIP server suite comprising proxy, presence and group chat functions.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,821 | 🐛 376 | 🌐 C | 📅 2026-03-26 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 1,920 | 🐛 43 | 🌐 Shell | 📅 2026-04-02 - Multi-protocol capturing and monitoring framework for RTC.
...
* [SIPVicious](https://github.com/EnableSecurity/sipvicious) ⭐ 1,063 | 🐛 0 | 🌐 Python | 📅 2026-03-06 - Suite of security tools that can be used to audit SIP based VoIP systems.
* [sipexer](https://github.com/miconda/sipexer) ⭐ 382 | 🐛 2 | 🌐 Go | 📅 2026-04-03 - Modern and flexible SIP command line tool.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,751 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-30 - Telecommunication stack built with Node.js.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,544 | 🐛 141 | 🌐 C++ | 📅 2026-03-29 - Standalone WebRTC DataChannels C++ implementation.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,672 | 🐛 0 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
