...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 933 | 🐛 105 | 🌐 C | 📅 2026-04-16 - RTP and UDP based media traffic proxy, usable as a kernel module.
* [SEMS](https://github.com/sems-server/sems) ⭐ 183 | 🐛 10 | 🌐 C++ | 📅 2026-04-17 - Open source media and application server for SIP based VoIP services.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,875 | 🐛 369 | 🌐 C | 📅 2026-04-16 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 1,921 | 🐛 43 | 🌐 Shell | 📅 2026-04-16 - Multi-protocol capturing and monitoring framework for RTC.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,770 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-08 - Telecommunication stack built with Node.js.
* [IVOZ Provider](https://github.com/irontec/ivozprovider) ⭐ 221 | 🐛 89 | 🌐 PHP | 📅 2026-04-16 - Multitenant solution for VoIP telephony providers.
...
* [adapter.js](https://github.com/webrtcHacks/adapter) ⭐ 3,736 | 🐛 10 | 🌐 JavaScript | 📅 2026-04-16 - JavaScript shim for abstracting WebRTC spec changes and inconsistencies.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,561 | 🐛 136 | 🌐 C++ | 📅 2026-04-15 - Standalone WebRTC DataChannels C++ implementation.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,698 | 🐛 1 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
