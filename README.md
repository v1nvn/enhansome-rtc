...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 934 | 🐛 105 | 🌐 C | 📅 2026-04-15 - RTP and UDP based media traffic proxy, usable as a kernel module.
* [SEMS](https://github.com/sems-server/sems) ⭐ 183 | 🐛 8 | 🌐 C++ | 📅 2026-04-15 - Open source media and application server for SIP based VoIP services.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,870 | 🐛 369 | 🌐 C | 📅 2026-04-14 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,769 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-08 - Telecommunication stack built with Node.js.
...
* [simple-peer](https://github.com/feross/simple-peer) ⭐ 7,788 | 🐛 128 | 🌐 JavaScript | 📅 2024-06-26 - WebRTC video, voice, and data channels abstraction for Node.js and the browser.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,560 | 🐛 135 | 🌐 C++ | 📅 2026-04-15 - Standalone WebRTC DataChannels C++ implementation.
* [libSRTP](https://github.com/cisco/libsrtp) ⭐ 1,373 | 🐛 33 | 🌐 C | 📅 2026-03-14 - Secure Real-time Transport Protocol (SRTP) library for C.
* [usrsctp](https://github.com/sctplab/usrsctp) ⭐ 750 | 🐛 167 | 🌐 C | 📅 2025-10-16 - Portable Stream Control Transmission Protocol (SCTP) user-land stack.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,039 | 🐛 36 | 🌐 Python | 📅 2025-11-29 - WebRTC and ORTC implementation for Python using asyncio.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,696 | 🐛 1 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 923 | 🐛 1 | 🌐 Python | 📅 2026-04-14 - Telco resources and projects.
* [Awesome 5G](https://github.com/calee0219/awesome-5g) ⭐ 877 | 🐛 4 | 🌐 Shell | 📅 2026-02-03 - 5G frameworks, libraries, software and resources.
