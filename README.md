...
* [Sippy B2BUA](https://github.com/sippy/b2bua) ⭐ 195 | 🐛 28 | 🌐 Python | 📅 2026-02-15 - Back-to-back user agent server written in Python.
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 175 | 🐛 20 | 🌐 C++ | 📅 2026-02-13 - SIP server suite comprising proxy, presence and group chat functions.
...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 910 | 🐛 113 | 🌐 C | 📅 2026-02-13 - RTP and UDP based media traffic proxy, usable as a kernel module.
* [SEMS](https://github.com/sems-server/sems) ⭐ 181 | 🐛 18 | 🌐 C++ | 📅 2026-02-11 - Open source media and application server for SIP based VoIP services.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 13,603 | 🐛 376 | 🌐 C | 📅 2026-02-16 - Fully featured TURN/STUN server supporting multiple platforms.
* [STUNTMAN](https://github.com/jselbie/stunserver) ⭐ 1,578 | 🐛 12 | 🌐 C++ | 📅 2026-02-13 - RFC compliant open source STUN implementation.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 1,901 | 🐛 44 | 🌐 Shell | 📅 2026-02-10 - Multi-protocol capturing and monitoring framework for RTC.
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,158 | 🐛 74 | 🌐 C | 📅 2026-01-26 - Terminal based SIP flow viewer.
...
* [sipexer](https://github.com/miconda/sipexer) ⭐ 377 | 🐛 2 | 🌐 Go | 📅 2026-01-05 - Modern and flexible SIP command line tool.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 7,553 | 🐛 16 | 🌐 TypeScript | 📅 2026-02-16 - Telecommunication stack built with Node.js.
* [IVOZ Provider](https://github.com/irontec/ivozprovider) ⭐ 221 | 🐛 85 | 🌐 PHP | 📅 2026-02-09 - Multitenant solution for VoIP telephony providers.
* [Sayna](https://github.com/SaynaAI/sayna) ⭐ 124 | 🐛 0 | 🌐 Rust | 📅 2026-02-08 - Real-time speech infrastructure for voice AI with WebSocket streaming, SIP telephony and pluggable STT/TTS providers.
...
* [Socio](https://github.com/Rolands-Laucis/Socio) ⭐ 126 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-10 - A WebSocket Real-Time Communication (RTC) API framework. Realtime Front-end, Back-end reactivity.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,474 | 🐛 135 | 🌐 C++ | 📅 2026-02-07 - Standalone WebRTC DataChannels C++ implementation.
* [libSRTP](https://github.com/cisco/libsrtp) ⭐ 1,359 | 🐛 38 | 🌐 C | 📅 2026-02-08 - Secure Real-time Transport Protocol (SRTP) library for C.
* [usrsctp](https://github.com/sctplab/usrsctp) ⭐ 742 | 🐛 167 | 🌐 C | 📅 2025-10-16 - Portable Stream Control Transmission Protocol (SCTP) user-land stack.
...
* [Sofia-SIP](https://github.com/freeswitch/sofia-sip) ⭐ 323 | 🐛 109 | 🌐 C | 📅 2025-11-14 - Open source SIP library used by FreeSWITCH.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,009 | 🐛 34 | 🌐 Python | 📅 2025-11-29 - WebRTC and ORTC implementation for Python using asyncio.
...
* [rtcrs/webrtc](https://github.com/rtcrs/webrtc) ⭐ 4,935 | 🐛 3 | 🌐 Rust | 📅 2026-02-10 - WebRTC stack, supporting SDP, RTP, RTCP and SRTP.
...
* [dart-sip-ua](https://github.com/cloudwebrtc/dart-sip-ua) ⭐ 369 | 🐛 163 | 🌐 Dart | 📅 2025-12-10 - Dart-lang port of JsSIP, capable of SIP over WebSocket.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,607 | 🐛 0 | 📅 2025-06-08 - Research resources in the 3G/4G/5G Cellular security space.
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 897 | 🐛 1 | 🌐 Python | 📅 2026-02-08 - Telco resources and projects.
* [Awesome 5G](https://github.com/calee0219/awesome-5g) ⭐ 866 | 🐛 4 | 🌐 Shell | 📅 2026-02-03 - 5G frameworks, libraries, software and resources.
* [Awesome RTC Hacking](https://github.com/EnableSecurity/awesome-rtc-hacking) ⭐ 512 | 🐛 0 | 📅 2025-07-25 - Real Time Communications hacking and penetration testing resources.
